<div style="padding: 5px;font-family:微软雅黑;">
	...
	-->
            <tr>
                ...
                <td>${webAccessToken}
                    ...
                    <a href="#" class="easyui-linkbutton" plain="true"
                       onclick="refresh_access_token('web_access_token')"><i
                                class="fa fa-refresh fa-lg fa-fw fa-col"></i>刷新access_token</a>
                    <br/>
            ...
            <tr>
                ...
                <td>${jsApiTicket}
                    <br/>
                    <a href="#" class="easyui-linkbutton" plain="true" onclick="refresh_access_token('jsapi_ticket')"><i
                                class="fa fa-refresh fa-lg fa-fw fa-col"></i>刷新jsApiTicket</a>
                    <br/>
                ...
                <#list map?keys as keystr>
                    ...
                    <tr>
                        ...
                        <td>${map[keystr]}
                            <br/>
                            <a href="#" class="easyui-linkbutton" plain="true"
                               onclick="refresh_access_token('mini_access_token@${keystr}')"><i
                                        class="fa fa-refresh fa-lg fa-fw fa-col"></i>刷新access_token</a>
                            <br/>
